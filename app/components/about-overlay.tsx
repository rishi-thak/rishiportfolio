...
export function AboutOverlay({ onClose }: { onClose: () => void }) {
     ...
     return (
          <div onClick={onClose} style={{ position: "fixed", inset: 0, zIndex: 100, background: "rgba(0,0,0,0.75)", display: "flex", alignItems: "center", justifyContent: "center" }}>
               <div onClick={e => e.stopPropagation()} className="expanded-card" style={{ width: "min(850px, 92vw)", background: greenAccent, border: "4px solid #000", boxShadow: `10px 10px 0 #000`, position: "relative", overflow: "hidden", display: "flex", flexDirection: "column" }}>
                    ...
                    {/* Content Section */}
                    <div style={{ padding: "24px 30px", display: "grid", gridTemplateColumns: "1fr 1.3fr", gap: 24, position: "relative", zIndex: 1, minHeight: 420 }}>

                         {/* Left Column: Stats & Status */}
                         <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                              <div style={{ background: inkBlack, border: `3px solid ${greenAccent}`, padding: 15, position: "relative", boxShadow: "4px 4px 0 #000" }}>
                              ...
                              <div style={{ background: "#fff", border: "3px solid #000", padding: 15, boxShadow: "6px 6px 0 #000", position: "relative" }}>
                              ...
                              <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", opacity: 0.9 }}>
                         ...
                         <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
                              <div style={{ background: "#FFE500", border: "3px solid #000", padding: "20px 24px", boxShadow: "8px 8px 0 #000" }}>
